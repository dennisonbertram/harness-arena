...
export function acquireDirectoryLock(lockPath: string, options?: { staleMs?: number; timeoutMs?: number; pollMs?: number; confinementRoot?: string; beforePublish?: () => void | Promise<void> }): Promise<() => Promise<void>>;
